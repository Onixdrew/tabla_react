...
//               <th className="border-2 py-3 px-10">editar</th>
//             </tr>
//           </thead>
//           <tbody>
...
//                   <button
//                     className="w-14 hover:w-[90%] text-white bg-red-600 rounded-full shadow-md shadow-black"
...
//                 <td className="border-2 py-3 px-10">
//                   <button
//                     className="w-14 hover:h-[10%] text-white bg-white-600 rounded-full shadow-md shadow-black"
//                     >
//                     🖊️
//                   </button>
